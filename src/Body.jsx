...
const Body = () => {
  ...
  <form className="flex flex-col p-14 w-[350px] border  border-black bg-[#d1cfc8] shadow-[5px_5px_0px_#000]">
...
<div className='flex justify-center items-center p-1 mt-48 text-xl font-mono'>
